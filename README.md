...
![StartGif](images/StartBYOF_Alt.gif)
...
![InteractionsGif](images/InteractionsBYOF_Alt.gif)
...
Ieder systeem is gebouwd om uitbereidbaar te zijn en om te anticiperen op toekomstige keuzes. Zo zijn bijvoorbeeld game variabelen als grid grootte en level lengte dynamisch aanpasbaar. Hierdoor kunnen veranderende eisen, door bijvoorbeeld playtests, zonder problemen geimplementeerd worden.
Daarnaast heb ik met data objecten gewerkt zodat content makkelijk uitbereidbaar is, zonder de code te beinvloeden. Zo anticipeer ik op dat ik of een andere programmeur in staat is om met gemak het prototype verder uit te werken.
Tevens heb ik gezorgd voor lage koppeling tussen classes en enkel essentiële functionaliteiten openbaar gemaakt. 
